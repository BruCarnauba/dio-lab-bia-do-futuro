...
Na prática, o usuário acessa uma interface em Streamlit, digita sua dúvida e recebe respostas contextualizadas com base nos seus dados. Por exemplo: “Como funciona a reserva de emergência?” — o Beabá responde de forma didática, usando o perfil e histórico do cliente para tornar a explicação relevante.
